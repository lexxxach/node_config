        ...
        for (let entry of elemsTableHead) {
            ...
            if (!resp[entry.textContent.toLowerCase()]) {
                ...
                if (entry.textContent.toLowerCase() == 'адрес') {
                  ...
                  elemColArt.addEventListener('mouseenter', function () {
                    
                    if(!this.querySelector("[name='copyLable']")){

                     //   navigator.clipboard.writeText('kjhkh')

                    let elemCopy = new CopyContent(this.textContent)
                    ...
                    elemColArt.addEventListener('mouseleave', function () {
                    
                        let elCopy = elemColArt.querySelector("[name='copyLable']")
